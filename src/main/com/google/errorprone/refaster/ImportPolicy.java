...
public enum ImportPolicy {
  ...
  IMPORT_TOP_LEVEL {
    ...
    public JCExpression classReference(
        Inliner inliner, String topLevelClazz, String fullyQualifiedClazz) {
       ...
       * to the class name.
       */
      checkArgument(!topLevelClazz.isEmpty() && !fullyQualifiedClazz.isEmpty(),
          String.format(
      ...
      if (currentPackage == null || !currentPackage.getQualifiedName().contentEquals(packge)) {
        ...
        inliner.addImport(topLevelClazz);
      }
      return makeSelectExpression(inliner, qualifiedPath, topLevelPath.size() - 1);
    }
    ...
    public JCExpression staticReference(
        Inliner inliner, String topLevelClazz, String fullyQualifiedClazz, String member) {
